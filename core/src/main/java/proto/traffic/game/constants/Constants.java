...
public abstract class Constants {
    ...
    static {
        ...
        degreesToSpeedCoefficientMap.put(32, 0.8f);
        degreesToSpeedCoefficientMap.put(33, 0.8f);
        degreesToSpeedCoefficientMap.put(20, 0.8f);
        degreesToSpeedCoefficientMap.put(19, 0.8f);
        degreesToSpeedCoefficientMap.put(17, 0.8f);
        degreesToSpeedCoefficientMap.put(18, 0.8f);
        degreesToSpeedCoefficientMap.put(21, 0.8f);
        degreesToSpeedCoefficientMap.put(12, 0.6f);
        degreesToSpeedCoefficientMap.put(11, 0.6f);
        degreesToSpeedCoefficientMap.put(13, 0.6f);
        degreesToSpeedCoefficientMap.put(15, 0.6f);
        degreesToSpeedCoefficientMap.put(14, 0.6f);
        degreesToSpeedCoefficientMap.put(16, 0.6f);
